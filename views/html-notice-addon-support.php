...
<div id="message" class="updated woocommerce-message wc-connect wsoe-connect" style="padding: 10px">
	...
	<p class="submit">
		<a href="http://sharethingz.com/woocommerce-simply-order-export-add-on/" class="button-primary" target="_blank"><?php _e( 'Try Order Export Add-on', 'woocommerce-simply-order-export' ); ?></a>
